            ...
            <section className="relative pt-32 pb-20 px-6 min-h-[60vh] flex flex-col items-center justify-center text-center">
                ...
                >
                    ...
                    <motion.h1 variants={fadeInUp} className="text-5xl md:text-8xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/40 mb-8">
                        Te invitamos a colaborar, <span className="text-amber-500">Restonic4.</span>
                    </motion.h1>
            ...
            <section className="py-10 px-6 bg-neutral-950/50">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-400">Estas son algunas de las soluciones que podemos ofrecerte al colaborar con nosotros.</p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <RoadmapCard
                            ...
                            title="Financiamos otros Proyectos"
                            desc="Ofrecemos financiación a otros proyectos externos a POLLNOW. Admitimos proyectos de cualquier tamaño. A cambio de publicitar nuestra plataforma dentro de tu proyecto o eventos."
                            status="Ideal para Empresas"
                            colSpan="md:col-span-2"
                        />
                        {/* Card 2 */}
                        <RoadmapCard
                            icon={<Zap className="text-yellow-400" />}
                            title="Publicidad Mútua"
                            desc="Tu proyecto se publicita dentro de nuestra plataforma, y POLLNOW se publicita dentro de tu proyecto. Simple."
                            status="Opción Rápida"
                        />
                        {/* Card 3 */}
                        <RoadmapCard
                            icon={<Palette className="text-purple-400" />}
                            title="Diseños Profesionales"
                            desc="Te ayudamos a crear un diseño profesional para tu proyecto. A cambio de publicitar nuestra plataforma dentro de tu proyecto o eventos."
                            status="Asesoramiento Premium"
                        />
                        {/* Card 4 */}
                        <RoadmapCard
                            icon={<Heart className="text-red-400" />}
                            title="Desarrollo de Proyectos Web"
                            desc="Creamos aplicaciones web personalizadas para tu proyecto o negocio. A cambio de publicitar nuestra plataforma dentro de tu proyecto o eventos."
                            status="Proyectos Personalizados"
                            colSpan="md:col-span-2"
                        />
                    </div>
                </div>
                        ...
                        <motion.form action={"https://submit-form.com/dIye1ORvC"} variants={fadeInUp} className="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="colab-type" id="colab-type" className="w-full bg-black/50 border-2 border-white/10 rounded-xl p-4 text-white focus:border-blue-500 focus:outline-none transition-colors">
                                    ...
                                    <option value="web-project">Proyecto Web</option>
